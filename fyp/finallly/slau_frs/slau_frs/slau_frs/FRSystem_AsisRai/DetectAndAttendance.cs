...
namespace FRSystem_AsisRai
{
    public partial class DetectAndAttendance : Form
    {
        ...
        {
            con = new SqlConnection(@"Data Source=(LocalDB)\slau;AttachDbFilename=F:\FYPROJECT\FACIAL C#\finallly\slau_frs\slau_frs\slau_frs\frsystem_database.mdf;Integrated Security=True;Connect Timeout=30");
        ...
        public void FrameGrabber(object sender, EventArgs e)
        {
          ...
          new Size(20, 20));
            ...
            for (int nnn = 0; nnn < facesDetected[0].Length; nnn++)
            {
                ...
                System.IO.File.AppendAllText("F:\\FYPROJECT\\FACIAL C#\\finallly\\slau_frs\\slau_frs\\slau_frs\\FRSystem_AsisRai\\Names\\names.txt", test);
        ...
        {
            using (SqlConnection Connection = new SqlConnection(@"Data Source=(LocalDB)\slau;AttachDbFilename=F:\FYPROJECT\FACIAL C#\finallly\slau_frs\slau_frs\slau_frs\frsystem_database.mdf;Integrated Security=True;Connect Timeout=30"))
            {
